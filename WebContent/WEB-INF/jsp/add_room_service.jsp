            ...
            <div class="container">
                <div class="col-xl-5 mx-auto text-center p-4">
                    <form class="form-login login-form" action="controller" method="post">
                        ...
                        <input type="hidden" name="id" value="${requestScope.room_service.id}"/>
                        <div class="form-group">
                            <div class="form-row">
                                <label for="room_service_name">${room_service_name}:&nbsp;&nbsp;&nbsp;</label>
                                <input class="form-control" id="room_service_name" type="text"
                                       placeholder="${room_service_name}" value="${requestScope.room_service.room_service_name}"
                                       name="room_service_name" pattern="[А-я ]{4,}"/>
                            </div>
                            <div class="form-row">
